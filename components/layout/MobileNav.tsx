...
import {
  ...
  LayoutDashboard, FileText, ScanLine, User, Users, Stethoscope, Calendar, ClipboardList,
} from "lucide-react";
...
export function MobileNav({ navLinks, userName, userRole }: Props) {
    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-zinc-100">
          ...
          {/* Déconnexion via lien pour éviter la sérialisation de server action */}
