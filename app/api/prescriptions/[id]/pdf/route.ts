...
// ============================================================
// NOTE: PAS de JSX ici — React.createElement pur pour éviter
// le conflit d'instances React avec @react-pdf/renderer en prod.
// ============================================================
...
export async function GET(
    ...
    include: {
      patient: {
        select: {
          ...
          phone: true, birthDate: true, nationalId: true,
        },
      },
      doctor: {
        select: {
          firstName: true, lastName: true, speciality: true,
          inami: true, email: true, phone: true,
        },
      },
    },
  });
  ...
  // Import dynamique pour rester côté Node.js (pas de bundling Webpack)
  ...
  const doctorName = p.doctor
    ...
    : ((p as { prescribingDoctorName?: string | null }).prescribingDoctorName
        ? `Dr. ${(p as { prescribingDoctorName?: string | null }).prescribingDoctorName}`
        : null);
      ...
      ce(View, { style: styles.section },
        ...
        ce(View, { style: styles.grid },
          ...
          ce(View, { style: styles.gridItem },
            ...
            ...(doctorName ? [ce(Text, { style: styles.personName }, doctorName)] : [ce(Text, { style: styles.personDetail }, "Non renseigne")]),
